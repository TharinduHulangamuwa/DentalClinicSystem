 ...
 *
 * DESIGN DECISION: the arithmetic and the receipt text live here, not in
 * the view. That keeps the calculation unit-testable (see BillTest) and
 * means the same Bill object can be rendered to a Swing text area today
 * and to a real printer or PDF later without changing this class.
 *
 * Fields are final because a bill, once issued, should not change.
 */
public class Bill {
    ...
    /** Total payable in LKR. */
    public double getTotal() {
        return treatmentCost + consultationFee;
    }

    /** Builds the plain-text receipt shown on screen and printed for the patient. */
